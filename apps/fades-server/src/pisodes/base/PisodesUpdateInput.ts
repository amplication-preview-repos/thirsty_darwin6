...
class PisodesUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => RediffusionsUpdateManyWithoutPisodesItemsInput,
  })
  @ValidateNested()
  @Type(() => RediffusionsUpdateManyWithoutPisodesItemsInput)
  @IsOptional()
  @Field(() => RediffusionsUpdateManyWithoutPisodesItemsInput, {
    nullable: true,
  })
...
export { PisodesUpdateInput as PisodesUpdateInput };
